...
type TrackingSidePanelsProps = {
  team: TrackingTeamMember[];
  deadlines: TrackingDeadline[];
  alerts: TrackingRiskAlert[];
};

export default function TrackingSidePanels({ team, deadlines, alerts }: TrackingSidePanelsProps) {
  return (

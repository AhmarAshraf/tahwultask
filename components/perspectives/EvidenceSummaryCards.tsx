...
type EvidenceSummaryCardKey = "totalEvidence" | "underReview" | "inProgress" | "completed";

type EvidenceSummaryCardsProps = {
  perspective: Perspective;
};

const cards: Array<{ key: EvidenceSummaryCardKey; label: string; Icon: typeof File }> = [
...
export default function EvidenceSummaryCards({ perspective }: EvidenceSummaryCardsProps) {
  return (

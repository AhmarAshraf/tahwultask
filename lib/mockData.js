...
export const summaryStats = [
  {
    ...
    value: "78.65%",
    icon: "/icons/ic_progress.png"
  },
  {
    id: 2,
    title: "Total Criteria",
    value: "95",
    icon: "/icons/ic_folder.png"
  },
  {
    id: 3,
    title: "Completed Criteria",
    value: "52",
    icon: "/icons/ic_tick_folder.png"
  },
  {
    id: 4,
    title: "Evidence Documents",
    value: "386",
    icon: "/icons/ic_safety.png"
  },
  {
    id: 5,
...
export const perspectivesData = [
  {
    ...
    leaders: [
      { name: "Ahmed Al-Ali", role: "Strategy Perspective", avatar: "/avatars/ahmed.jpg" },
      { name: "Ahmed Al-Ali", role: "Strategy Perspective", avatar: "/avatars/ahmed2.jpg" }
    ],
    evidence: [
      {
        docNumber: "5.4.1.1",

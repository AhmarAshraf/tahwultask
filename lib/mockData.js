...
/** @type {import("../types/models").TimelineItem[]} */
...
/** @type {import("../types/models").SummaryStat[]} */
...
/** @type {import("../types/models").ProgressStatusItem[]} */
...
/** @type {import("../types/models").PerformancePoint[]} */
...
/** @type {import("../types/models").Performer[]} */
...
/** @type {import("../types/models").RecentActivity[]} */
...
/** @type {import("../types/models").Perspective[]} */
...
/** @type {import("../types/models").AuditReadiness} */
...
/** @type {import("../types/models").TrackingSummaryMetric[]} */
...
/** @type {import("../types/models").TrackingRow[]} */
...
/** @type {import("../types/models").TrackingTeamMember[]} */
...
/** @type {import("../types/models").TrackingDeadline[]} */
...
/** @type {import("../types/models").TrackingRiskAlert[]} */
